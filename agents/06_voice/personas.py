...
PERSONAS = {
    ...
    "marcus": {
        ...
        "instructions": (
            ...
            "3) TRADE — trade_recommendation, then read the 'execution' block as your "
            "script, ALWAYS in this exact order, one line each:\n"
            ...
            "   d. STOP: the underlying level where the whole trade dies.\n"
