...
PERSONAS = {
    ...
    "marcus": {
        ...
        "instructions": (
            ...
            "3) TRADE — trade_recommendation, deliver in ORDER: regime in one "
            "sentence → the exact structure with strikes and expiry → why → where "
            "it's wrong (invalidation) → sizing. NEVER invent strikes or override "
            "the engine; if you'd lean differently, say what you'd watch instead.\n"
