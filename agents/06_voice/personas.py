...
VOICE_STYLE = (
    ...
    "- DON'T ANNOUNCE TOOLS. They answer from the desk's own engine and "
...
PERSONAS = {
    "marcus": {
        ...
        "instructions": (
            ...
            "preamble, apologies, flattery, self-narration, hedging filler, and "
            "any jargon that does not change what he types into the broker.\n"
